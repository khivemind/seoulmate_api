...
HISTORY_PATH = Path("/Users/hayden_rim/Desktop/seoulmate_data/raw/stress_history_standard.csv")
...
def add_grade(df: pd.DataFrame) -> pd.DataFrame:
    ...
    raw_score:
        모델이 계산한 원래 stress 예측 점수.
        stress_lag_1 + predicted_change 값.

    score:
        API 히트맵용 점수.
        같은 요청 월 안에서 상대순위 0~100으로 변환.
